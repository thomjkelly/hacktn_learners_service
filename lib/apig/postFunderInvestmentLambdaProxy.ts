...
import { postFunderInvestmentRequestSchema } from "./schemas";


export const addPostFunderInvestmentApiIntegration: (
    stack: Construct,
    api: RestApi,
    ...
    const namePrefix = "postFunderInvestment"
    ...
    const requestModel = api.addModel(
      `${namePrefix}RequestModel`,
      {
        ...
        schema: postFunderInvestmentRequestSchema
      }
    )
