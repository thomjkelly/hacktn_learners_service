...
export const addGetInvestmentForFunderApiIntegration: (
    stack: Construct,
    api: RestApi,
    ...
    const namePrefix = "getInvestmentForFunder"
    const getPolicy = new Policy(stack, `${namePrefix}Policy`, {
      ...
      const requestTemplate = `{
        ...
        #set($investmentid = $util.urlDecode($input.params('investmentid')))
        "TableName": "${table.tableName}",
        "Key": {
            "pk": {
                "S": "INVESTMENT#FUNDER#$id#"
            },
            "sk": {
